...
if target in content and "classic-topview-grid-page" not in content:
    content = content.replace(target, grid_html + "\n" + target)
    with open("modern_ui.js", "w", encoding="utf-8") as f:
        f.write(content)
    print("Injected HTML successfully.")
else:
    print("Target not found or HTML already injected.")
